...
const NFT = () => {
    ...
    const marketplace = useMarketplace("0xe5De8C34393983792Fe13adBc82E085fE88583DB")
                ...
                <div>
                    ...
                    <div className="py-24">
                        ...
                        <div className="flex justify-center p-5">
                            Prior To Purchasing: Ensure you have connected your wallet with sufficient funds prior to reviewing.
                        </div>
                        <div className="flex justify-center p-5">
